 ...
 */
public interface EcmcRdsConfigurationService {
    /**
     * 创建客户配置文件
     ...
     * @throws Exception
     */
    public EayunResponseJson queryConfigFileByPrjAndVersion(String projectId, String version) throws Exception ;
