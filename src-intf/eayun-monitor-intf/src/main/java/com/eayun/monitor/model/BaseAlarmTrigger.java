...
@Entity
@Table(name = "ecsc_alarmtrigger")
public class BaseAlarmTrigger implements Serializable {

    private static final long serialVersionUID = -8259308167416599599L;
    ...
    private String            zb;                                       //存储的是监控指标（如CPU利用率等）的nodeId，方便在缓存的数据字典中读取

    @Column(name = "at_operator", length = 32)
    private String            operator;									//操作符，><等
    ...
    private String            isTriggered;                             //是否已触发报警
