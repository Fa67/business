...
public class ClientGlobal {
    ...
    */
    public static void init(String conf_filename) throws FileNotFoundException, IOException,
                                                 MyException {
        ...
        for (int i = 0; i < szTrackerServers.length; i++) {
            ...
            tracker_servers[i] = new InetSocketAddress(parts[0].trim(), Integer.parseInt(parts[1]
                .trim()));
        }
