...
import com.eayun.obs.thread.ObsDetailMonthSummaryPool;
import com.eayun.obs.thread.ObsDetailMonthSummaryThread;
...
public class ObsDetailMonthSummaryJob extends BaseQuartzJobBean {

	private final Logger log = LoggerFactory.getLogger(ObsDetailMonthSummaryJob.class);
	...
	protected void executeInternal(JobExecutionContext context)
		...
		if(obsUsers != null){
		      for (String cusId : obsUsers) {
		            ...
		            ObsDetailMonthSummaryThread thread = new ObsDetailMonthSummaryThread(mongoTemplate, cusId);
		            ObsDetailMonthSummaryPool.pool.submit(thread);
		      }
		}
